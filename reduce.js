...
function vowelCount(str) {
    ...
    let input = Array.from(str.toLowerCase());
    // console.log('Converted to Array: ', input);
    return input.reduce(function(accum, val) {
        // console.log('Accumulator: ', accum);
        // console.log('Value: ', val);
...
function addKeyAndValue(arr, key, value) {
    ...
    // console.log('Value for New Key: ', value);
